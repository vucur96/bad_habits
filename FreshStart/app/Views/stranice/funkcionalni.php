...
<h1>Treninzi</h1>
<h2><span><a href="i<?php echo site_url('index') ?>">Početna</a> | <a href="<?php echo site_url('Gost/classes') ?>">Treninzi</a> | Funkcionalni trening</span></h2>
</div>
</div>
</div>
</div>
...
<div class="classes">
							<div class="classes-img classes-img-single" style="background-image: url('/New folder/images/funkcionalni.jpg');"></div>
							<div class="desc">
