...
<h1>Treninzi</h1>
<h2><span><a href="<?php echo site_url('index') ?>">Početna</a> | <a href="<?php echo site_url('Gost/classes') ?>">Treninzi</a> | Karate</span></h2>
</div>
</div>
</div>
</div>
...
<div class="classes">
							<div class="classes-img classes-img-single" style="background-image: url('/New folder/images/karate.jpg');"></div>
							<div class="desc">
                                                            <h3>KARATE</h3>
