...
<h1>Treninzi</h1>
<h2><span><a href="<?php echo site_url('index') ?>">Početna</a> | <a href="<?php echo site_url('Gost/classes') ?>">Treninzi</a> | Individualni treninzi</span></h2>
</div>
</div>
</div>
</div>
...
<div class="classes">
							<div class="classes-img classes-img-single" style="background-image: url('/New folder/images/classes-1.jpg');"></div>
							<div class="desc">
                                                            <h3>INDIVIDUALNI TRENINZI</a></h3>
