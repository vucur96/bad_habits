...
--
-- Host: localhost:3308
-- Generation Time: Jun 07, 2020 at 03:27 PM
...
(5, 'kako ziveti zdravije', ' sve sto je potrebno kako biste unapredili vase zdrave navike', 'nikoleta');
...
--
ALTER TABLE `blog`
  ADD CONSTRAINT `blog_ibfk_1` FOREIGN KEY (`KorisnickoIme`) REFERENCES `admin` (`KorisnickoIme`);
