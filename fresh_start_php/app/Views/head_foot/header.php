					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown">
									<a href="schedule.html">Raspored</a>
									<ul class="dropdown">
										<li><a href="raspored_grupni_treninzi.html">Grupni treninzi</a></li>
										<li><a href="raspored_individualni_treninzi.html">Individualni treninzi</a></li>
