	...
	?>
			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Ima samo jedan način da stigneš na cilj pridruzi nam se!</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
						...
						<div class="intro-flex">
							...
							<div class="one-third intro-img" style="background-image: url(images/intro-img-3.jpg)">
								<div class="desc">
									...
									<span class="price text-center">3000rsd<br><small>/mesečno</small></span>
								</div>
							</div>
						</div>
		         </div>
		...
		<div id="colorlib-testimony" class="testimony-img" style="background-image: url(images/img_bg_2.jpg);" data-stellar-background-ratio="0.5">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
						<h2>Šta ljudi misle o nama</h2>
						<h3>Uspesi naših korisnika</h3>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								...
								<p><a href="cardio.php" class="btn-learn">Saznajte više <i class="icon-arrow-right3"></i></a></p>
							</div>
						</div>
					</div>
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								...
								<p><a href="funkcionalni.php" class="btn-learn">Saznajte više <i class="icon-arrow-right3"></i></a></p>
							</div>
						</div>
					</div>
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								...
								<p><a href="yoga.php" class="btn-learn">Saznajte više <i class="icon-arrow-right3"></i></a></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-4 animate-box">
						<article class="article-entry">
							...
							<div class="desc">
								...
								<h2><a href="blog.php">Kako se najbolje pripremiti za biciklijadu</a></h2>
